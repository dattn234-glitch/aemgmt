export const company = {
  ...
  phone: "+65 8123 4567", // [CLIENT TO CONFIRM]
  email: "hello@aemanagementservices.sg", // [CLIENT TO CONFIRM]
  uen: "[CLIENT TO CONFIRM]", // [CLIENT TO CONFIRM]
  serviceHours: "Mon-Sun · 8 AM - 6 PM", // [CLIENT TO CONFIRM]
  serviceArea: "Singapore island-wide",
  whatsappNumber: "6581234567", // [CLIENT TO CONFIRM]
  whatsappHref:
    "https://wa.me/6581234567?text=Hi%20AE!%20I%20would%20like%20to%20confirm%20a%20home%20cleaning%20booking.",
  rates: {
    minHours: 3,
    durations: [3, 4],
    weekly: 25,
